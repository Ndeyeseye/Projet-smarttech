...
<head>
    ...
    <title>Liste des employés - Smarttech</title>
...
<body>
    ...
    <div class="container mt-5">
        ...
        <a href="create.php" class="btn btn-primary mb-3">Ajouter un employé</a>
            ...
            <tbody>
                <?php foreach ($employes as $employe) : ?>
                    <tr>
                        ...
                        <td>
                            <a href="update.php?id=<?php echo $employe['id']; ?>" class="btn btn-warning btn-sm">Modifier</a>
                            <a href="delete.php?id=<?php echo $employe['id']; ?>" class="btn btn-danger btn-sm">Supprimer</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
