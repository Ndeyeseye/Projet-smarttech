...
<head>
    ...
    <title>Liste des clients - Smarttech</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="read.php">Clients</a>
                    </li>
                    <li class="nav-item">
            ...
            <tbody>
                <?php foreach ($clients as $client) : ?>
                    <tr>
                        ...
                        <td>
                            <a href="update.php?id=<?php echo $client['id']; ?>" class="btn btn-warning btn-sm">Modifier</a>
                            <a href="delete.php?id=<?php echo $client['id']; ?>" class="btn btn-danger btn-sm">Supprimer</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
